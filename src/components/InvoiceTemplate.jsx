          ...
          {items.map((item, index) => (
            <tr key={index}>
              ...
              <td style={{ textAlign: "left", fontWeight: "700", color: "#111" }}>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", justifyContent: "center", height: "100%", minHeight: "28px" }}>
                {item.discountPct >= 100 ? (
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "3px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                      <div style={{ background: "#e3f2fd", border: "1px solid #64b5f6", borderRadius: "4px", padding: "1px 7px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", lineHeight: 1.35 }}>
              ...
              <td style={{ textAlign: "center" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", minHeight: "28px" }}>
                {item.discountPct >= 100 ? (
