...
export function CatalogTab({
  ...
  return (
    <div style={{ padding: "0 0 100px" }} dir="rtl">
      ...
      >
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          <div style={{ flex: 1, minWidth: 0, display: "flex", alignItems: "center", background: "#161616", border: "1px solid #232323", borderRadius: 8, padding: "0 10px", gap: 6, height: 32, minHeight: 32, boxSizing: "border-box" }}>
